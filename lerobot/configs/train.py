...
class TrainPipelineConfig(HubMixin):
    ...
    num_workers: int = 4 
    batch_size: int = 4 # number to be changed to 80
    steps: int = 40 # number to be changed to 100_000
    eval_freq: int = 20 # number to be changed to 20_000
    log_freq: int = 10 # number to be changed to 200
    save_checkpoint: bool = True
    # Checkpoint is saved every `save_freq` training iterations and after the last training step.
    save_freq: int = 20 # number to be changed to 20_000
